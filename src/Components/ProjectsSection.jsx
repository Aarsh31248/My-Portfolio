...
const projects = [
  {
    id: 1,
    title: "NetflixGPT",
    description: "Netflix-inspired app with authentication and OpenAI-powered movie recommendations, built using React, Redux, and Tailwind.",
  ...
  },
  {
    id: 2,
    title: "Youtube Clone",
    description: "YouTube clone using YouTube API for videos & suggestions, with debounced search and a real-time optimized live chat experience.",
  ...
  },
  {
    id: 3,
    title: "Blog App",
    description: "Blog app with full CRUD functionality, users can explore posts with a clean UI, built using React, Redux, and Tailwind with responsive UI.",
          ...
          {projects.map((project, key) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-1 -mt-1"> {project.title}</h3>
